...
namespace BH.Engine.Adapters.AGS
{
    public static partial class Compute
    {
        ...
        [Description("Calculates a Levenshtein simple ratio between the strings. Inconsistent substrings lead to problems in matching. " +
            "This ratio uses a heuristic called 'best partial' for when two strings are of noticeably different lengths. This makes use of the FuzzySharp library.")]
